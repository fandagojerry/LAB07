...
<body>
<header>
	<h1>More on the three students</h1>
</header>
<?php include "inc/nav.inc"; ?>
	...
	<h3>music</h3>
      <p>This past summer was affirming that I’ve chosen the right path. I
      worked at a digital media and PR firm that works with classical musicians. I loved
      the experience, and worked on a lot of different projects for different artists.
      I added content (mostly concert dates) to websites, updated and checked up on
      Facebook pages, worked with photo and video content, updated PR logs and helped
      to created digital media plans at the quarter. I learned a lot about the
      classical music industry, and that I really liked working with clients in the arts.
      After graduation, I plan to pursue working on digital media for arts-based clients.
     </p>
     <h3>film</h3>
     <p>Last fall, I studied abroad in London, and I had an internship at a firm
      ...
      them into YouTube videos. I had the chance to interview stars, directors,
      and producers for a film festival in junket setting (sitting down in a room
     ...
     <p>I also love photography and the arts, and am a digital photographer, though
      I love working with film photography as well. My sophomore year, I took an
      Art History class about early photography, and we took frequent trips to the
      Eastman Museum as part of the course. For a final project in that class,
      I studied one of the nine remaining Daugerreotypes (the first form of permanent
      photography) of Fredrick Douglass, which was on loan at the Rare Books and
	...
	<p>When I started elementary school, I didn’t speak much English, so I had to take ESL classes. I picked it up quickly, and started to love reading, which probably helped. I ended up testing into a magnet middle school for music, so I spent three years pretending I knew how to play the cello. The middle school had an advanced curriculum, which prepared me well for the SHSAT, a standardized exam New Yorkers take to gain admission into selective high schools. I scored pretty high, and went to the “#1 public high school in NYC”. It was super competitive, but they offered a wide variety of courses, like Organic Chemistry.</p>

	<h3>College Education</h3>
	<p>Taking Orgo in high school convinced me I wanted to work with Chemistry for the rest of my life, so I applied to way too many colleges as a Chemical Engineering major. Fast forward eight months, and I wound up at the University of Rochester. I took my introductory engineering courses and realized I did not want to be in a lab for the rest of my life. I did take a super interesting Economics course, and changed my major to Business by the end of my freshman year. It was one of the better decisions I’ve made, but I still missed using the more computational part of my brain, so I decided to give Computer Science another shot (I had taken a few classes in high school), and turned that into a minor.</p>

</article>
<footer>
	<p>Instagram: @bongard.jpg</p>
</footer>
